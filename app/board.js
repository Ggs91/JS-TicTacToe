...
export default (function(doc){
  ...
  function _generateBoardCasesIDsArray(gridSize){ //Method that generate cases ID's names depending on the desired gridsize
    const arrayOfCases = [];
  ...
  function findCaseByID(boardID){ //Maps the HTML id's attribute of the div element with the corresponding boardcase object in the Board.boardCase property
